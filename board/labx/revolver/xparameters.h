...
/* Definitions for peripheral DDR3_CONTROL */
#define XPAR_DDR3_CONTROL_DEVICE_ID 0
#define XPAR_DDR3_CONTROL_MPMC_CTRL_BASEADDR 0xFFFFFFFF
#define XPAR_DDR3_CONTROL_INCLUDE_ECC_SUPPORT 0
#define XPAR_DDR3_CONTROL_USE_STATIC_PHY 0
#define XPAR_DDR3_CONTROL_PM_ENABLE 0
#define XPAR_DDR3_CONTROL_NUM_PORTS 4
#define XPAR_DDR3_CONTROL_MEM_DATA_WIDTH 16
#define XPAR_DDR3_CONTROL_MEM_PART_NUM_BANK_BITS 3
#define XPAR_DDR3_CONTROL_MEM_PART_NUM_ROW_BITS 13
#define XPAR_DDR3_CONTROL_MEM_PART_NUM_COL_BITS 10
#define XPAR_DDR3_CONTROL_MEM_TYPE DDR3
#define XPAR_DDR3_CONTROL_ECC_SEC_THRESHOLD 1
#define XPAR_DDR3_CONTROL_ECC_DEC_THRESHOLD 1
#define XPAR_DDR3_CONTROL_ECC_PEC_THRESHOLD 1
#define XPAR_DDR3_CONTROL_MEM_DQS_WIDTH 2
#define XPAR_DDR3_CONTROL_MPMC_CLK0_PERIOD_PS 8000
...
/* Definitions for peripheral DDR3_CONTROL */
#define XPAR_DDR3_CONTROL_MPMC_BASEADDR 0x88000000
#define XPAR_DDR3_CONTROL_MPMC_HIGHADDR 0x8FFFFFFF
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL0 0x000
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL0 0x00d
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL2 0x018
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL2 0x025
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL3 0x026
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL3 0x02f
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL4 0x030
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL4 0x03d
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL5 0x03e
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL5 0x047
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL6 0x048
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL6 0x05b
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL7 0x05c
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL7 0x06a
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL8 0x06b
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL8 0x086
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL9 0x087
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL9 0x09d
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL10 0x09e
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL10 0x0a5
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL11 0x0a6
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL11 0x0ad
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL12 0x0ae
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL12 0x0b5
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL13 0x0b6
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL13 0x0bd
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL14 0x0be
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL14 0x0d0
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL15 0x0d1
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL15 0x0d8
#define XPAR_DDR3_CONTROL_BASEADDR_CTRL16 0x0d9
#define XPAR_DDR3_CONTROL_HIGHADDR_CTRL16 0x0da


/******************************************************************/

/* Canonical definitions for peripheral DDR3_CONTROL */
#define XPAR_MPMC_0_DEVICE_ID XPAR_DDR3_CONTROL_DEVICE_ID
...
#define XPAR_DEPACKETIZER_DMA_SLAVE_BASEADDR 0x820E0000
#define XPAR_DEPACKETIZER_DMA_SLAVE_HIGHADDR 0x820EFFFF
...
#define XPAR_ETH01_AUDIO_PACKETIZER_SLAVE_BASEADDR 0x82090000
#define XPAR_ETH01_AUDIO_PACKETIZER_SLAVE_HIGHADDR 0x8209FFFF


/* Definitions for peripheral ETH0_AUDIO_DEPACKETIZER */
#define XPAR_ETH0_AUDIO_DEPACKETIZER_SLAVE_BASEADDR 0x82100000
#define XPAR_ETH0_AUDIO_DEPACKETIZER_SLAVE_HIGHADDR 0x8210FFFF
...
#define XPAR_ETH1_AUDIO_DEPACKETIZER_SLAVE_BASEADDR 0x82110000
#define XPAR_ETH1_AUDIO_DEPACKETIZER_SLAVE_HIGHADDR 0x8211FFFF
...
#define XPAR_LABX_TDM_AUDIO_0_SLAVE_BASEADDR 0x820B0000
#define XPAR_LABX_TDM_AUDIO_0_SLAVE_HIGHADDR 0x820BFFFF
...
#define XPAR_HOST_SERIAL_BAUDRATE 19200
...
#define XPAR_UARTLITE_0_BAUDRATE 19200
...
#define XPAR_IRQ_CONTROL_KIND_OF_INTR 0xFFFC01C1
...
#define XPAR_XPS_SPI_0_IP2INTC_IRPT_MASK 0X004000
#define XPAR_IRQ_CONTROL_XPS_SPI_0_IP2INTC_IRPT_INTR 14
#define XPAR_ETH0_PHY_INTERRUPT_OUT_MASK 0X008000
#define XPAR_IRQ_CONTROL_ETH0_PHY_INTERRUPT_OUT_INTR 15
#define XPAR_PACKET_BRIDGE_INTERRUPT_MASK 0X010000
#define XPAR_IRQ_CONTROL_PACKET_BRIDGE_INTERRUPT_INTR 16
#define XPAR_LABX_TDM_AUDIO_0_INTERRUPT_MASK 0X020000
#define XPAR_IRQ_CONTROL_LABX_TDM_AUDIO_0_INTERRUPT_INTR 17
...
#define XPAR_INTC_0_KIND_OF_INTR 0xFFFC01C1
